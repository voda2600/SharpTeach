...
";
    ...
    {
        Assert.AreEqual(CodeCompileChecker<string>.CheckSortedList(_validSortedListCode, "a", "b"), true);
        Assert.AreEqual(CodeCompileChecker<string>.CheckSortedList(_invalidSortedListCode, "a", "b"), false);
    }
}
