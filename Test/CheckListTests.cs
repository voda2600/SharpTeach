...
{
    private static string _invalidListCode = @"
...
";
    private static string _validListCode = TemplateList.ListCode;

    [Test]
    public void TestList()
    {
        Assert.AreEqual(CodeCompileChecker<int>.CheckList(_validListCode, 8), true);
        Assert.AreEqual(CodeCompileChecker<int>.CheckList(_invalidListCode, 8), false);
    }
